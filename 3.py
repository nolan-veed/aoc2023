s = """........................................................862...........20.............453...619......58........694...312.................292.
...
top_line = None
middle_line = None
for bottom_line in s.split('\n'):
    bottom_line = '.' + bottom_line + '..'
    if middle_line is None:
        middle_line = bottom_line
        continue
    if top_line is None:
        top_line = "." * len(middle_line)
    ...
    print(middle_line)
    print(bottom_line)
    for i in range(1, len(middle_line) - 1):
        ...
        #
        #     if not is_num:
        #         if top_line[i - 1] != '.' and not top_line[i - 1].isdigit():
        #             print("case1")
        #             is_num = True
        ...
        #             is_num = True
        #
        #         if middle_line[i - 1] != '.' and not middle_line[i - 1].isdigit():
        #             print("case4")
        #             is_num = True
        #         if middle_line[i + 1] != '.' and not middle_line[i + 1].isdigit():
        #             print("case5")
        #             is_num = True
        #
        #         if bottom_line[i - 1] != '.' and not bottom_line[i - 1].isdigit():
        #             print("case6")
        #             is_num = True
        ...
        if c == '*':
            ...
            product = 1
            if found < 2:
                count, n = find_numbers_at(i, top_line)
                print(count, n)
                if count > 0:
                    product = product * n
                    found = found + count
            if found < 2:
                count, n = find_numbers_at(i, middle_line)
                print(count, n)
                if count > 0:
                    product = product * n
                found = found + count
            if found < 2:
                count, n = find_numbers_at(i, bottom_line)
                print(count, n)
                if count > 0:
                    product = product * n
                    found = found + count
